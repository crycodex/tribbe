      ...
      return CupertinoOnboarding(
        ...
        pages: [
          WhatsNewPage(
            ...
            features: [
              WhatsNewFeature(
                icon: Icon(Icons.person_outline, size: 32, color: primaryColor),
                title: Text(
                  'Crea tu perfil',
                  style: TextStyle(
                    fontSize: 18,
                ...
                description: Text(
                  ...
                  style: TextStyle(fontSize: 16, color: onSurfaceVariantColor),
                ),
              ),
              WhatsNewFeature(
                icon: Icon(Icons.home_outlined, size: 32, color: primaryColor),
                title: Text(
                  'Gimnasio',
                  style: TextStyle(
                    fontSize: 18,
              ...
              WhatsNewFeature(
                icon: Icon(Icons.people_outline, size: 32, color: primaryColor),
                title: Text(
                  'Social',
                  style: TextStyle(
                    fontSize: 18,
